...
(13, 'Yugioh Yugi Reloaded Starter Deck', 'The original Dueling Legends get their Decks updated in Yugi — Reloaded and Kaiba — Reloaded Starter Decks. Each 50-card Deck features that character\'s favorite cards and is tuned to provide easy learning of the Yu-Gi-Oh! trading card game. Fans will love roleplaying and dueling with their hero\'s deck just like on TV! These starter decks were designed to be evenly matched and provide a fun and entertaining jumping-off point for new Duelists. With the ongoing popularity of the original TV series, fans with fond nostalgia have been asking for a modern revamp and their cries have been heard with the Yugi — Reloaded and Kaiba — Reloaded Starter Decks. ', 99.99, 'yu-gi-ohTCGstarterYugiReloaded.png', 50, 3, 0),
